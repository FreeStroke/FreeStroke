...
!system "copy ..\..\bin\Release\${PRODUCT_NAME}.exe result\${PRODUCT_NAME}.exe"
!system "copy ..\..\bin\Release\AESDH.dll result\AESDH.dll"
!system "copy ..\..\bin\Release\${PRODUCT_NAME}.exe ${PRODUCT_NAME}.exe"
