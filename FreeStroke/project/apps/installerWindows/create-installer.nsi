...
!define PRODUCT_NAME "FreeStroke"
...
!define MUI_FINISHPAGE_RUN "$INSTDIR\FreeStroke.exe"
...
!system "copy ..\..\win32\${PRODUCT_NAME}.exe result\${PRODUCT_NAME}.exe"
!system "copy ..\..\win32\${PRODUCT_NAME}.exe ${PRODUCT_NAME}.exe"
